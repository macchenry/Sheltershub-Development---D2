...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children, onNavigate, activePage, title, userRole }) => {
  ...
  const menuItems = isAdmin ? [...commonItems, ...adminItems.slice(0, 3), ...adminItems.slice(3, 5), adminItems[5]] : commonItems;
          ...
          <ul className="space-y-1 px-3">
            ...
            <li>
                ...
                >
                    ...
                    <svg className={`w-4 h-4 transition-transform ${isReportsOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg>
                </button>
